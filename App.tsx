  ...
  return (
    <ErrorBoundary>
      ...
      {view === 'landing' ? (
        ...
        <div className="fixed inset-0 flex overflow-hidden bg-[#0A0A0A] text-[#FAFAFA]">
          ...
          <div className="flex-1 flex flex-col relative min-w-0">
            ...
            <main
              className={`flex-1 overflow-y-auto p-4 md:p-6 custom-scrollbar relative ${currentMessages.length === 0 ? 'grid place-items-center' : ''}`}
            >
              <div className="max-w-5xl mx-auto w-full">
                {currentMessages.length === 0 ? (
                  <div className="flex flex-col items-center select-none px-4 animate-in fade-in duration-500 py-8 w-full">
                ...
                {isActiveChatLoading && (
                  <div className="flex flex-col items-center justify-center py-16 bg-[#0A0A0A] text-[#FAFAFA] font-sans">
                    <div className="flex flex-col items-center animate-in zoom-in-95 duration-700">
                      ...
                      <p className="mt-8 text-gray-400 text-sm font-medium opacity-60">
                        جاري التحميل...
                      </p>
                    </div>
                  </div>
